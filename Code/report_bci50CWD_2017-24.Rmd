...
### Total estimates for CWD stocks, fluxes and residence time for BCI 50ha plot
...
Annual variation in mean total mass of fallen and standing coarse woody debris (CWD) per hectare, with 95% confidence intervals.
...
Annual variation in mean total volume of fallen and standing CWD per hectare, with 95% confidence intervals.
...
```{r, echo=FALSE,results='hide', message=FALSE, warning=FALSE}
# Plotting histogram of standing CWD input mass per subplot, coloured by year (excluding 2009)
# X-axis is log₂-transformed mass
...
labs(title = "Mean Mass of Fallen CWD per Subplot Grouped by Maximum Total Mass Quantile", 
      x = "Year", 
...
Annual variation in estimated fallen CWD mass for each 40 × 40 m dynamic subplot, grouped by the subplot's maximum total mass quantile. Lines represent individual subplot trajectories over time.

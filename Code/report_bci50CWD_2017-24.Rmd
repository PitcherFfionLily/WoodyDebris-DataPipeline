---
title: "Dead wood stores and fluxes for BCI 50ha dynamic plots 2017-2024"
author: "Lily Pitcher"
date: "`r Sys.Date()`"
...
knitr::opts_knit$set(root.dir = root.dir = here::here())
...
kable(total_means, format = "html", row.names=FALSE, digits=2,
  ...
  kable_styling(bootstrap_options = c("striped", "hover", "bordered"),
                ...
                add_header_above(c("Summary of Mean Volume of Coarse Woody Debris" = 5))
```

...
taper_function <- function(indata) {
  ...
  indata$b <- ifelse(!is.na(indata$POM), 
                     ...
                     NA)
 #calculating new dbh correcting for point of measurement using model from Table 1, model 1 of of Cushman et al. 2014 Methods Ecology and Evolution DOI:10.1111/2041-210X.12187
